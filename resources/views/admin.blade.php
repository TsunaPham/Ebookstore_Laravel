...
$(document).ready(function() {
    ...
    $('#b-i12').click(function(){
        $.ajax({
            url: "{{ route('getTransactionCreditDay') }}",
            method: "GET",
            data: {
    ...
    $('#b-i13').click(function(){
        $.ajax({
            url: "{{ route('getErrorTransactionDay') }}",
            method: "GET",
            data: {
    ...
    $('#b-i14').click(function(){
        $.ajax({
            url: "{{ route('getWHhaveISBNlessthanN') }}",
            method: "GET",
            data: {
